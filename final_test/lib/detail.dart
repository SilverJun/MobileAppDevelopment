      ...
      children: <Widget>[
        ...
        Column(
          children: <Widget>[
            ...
            Text("Created: " + product.created.toDate().toString()),
            Text("Modified: " + (product.modified != null ? product.modified.toDate().toString() : '')),
          ],
        )
      ],
    );
          ...
          Builder(
            builder: (BuildContext context) {
              return IconButton(
                ...
                onPressed: () {
                  if (widget.product.uid == appProfile.user.uid) { // can edit
                    print("Can edit!");
